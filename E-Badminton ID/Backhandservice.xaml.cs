...
namespace E_Badminton_ID
{
    ...
    /// </summary>
    public sealed partial class Backhandservice : Page
    {
        public Backhandservice()
        {
            this.InitializeComponent();
            mymedia.Source = new Uri("ms-appx:///Assets/Tutorials/backhand service.mp4", UriKind.RelativeOrAbsolute);
        }
