...
namespace E_Badminton_ID
{
    ...
    /// </summary>
    public sealed partial class Forehandservice : Page
    {
        public Forehandservice()
        {
            this.InitializeComponent();
            mymedia.Source = new Uri("ms-appx:///Assets/Tutorials/Forehand service.mp4", UriKind.RelativeOrAbsolute);
        }
